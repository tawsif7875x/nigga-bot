...
config: {
	...
	countDown: 5,
	role: 0,
	guide: "<text> | reply | --user <uid> | --theme <theme number> | blank"
},
...
try {
		let url = `https://tawsifs-fakechat.onrender.com/image?name=${name}&avatar=${encodeURIComponent(avatarUrl)}&text=${encodeURIComponent(prompt)}`;
